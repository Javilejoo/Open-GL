...
class Renderer(object):
    ...
    def getViewMatrix(self):
        ...
        # Rotation X - Pitch
        pitch = glm.rotate(identity, glm.radians(self.camRotation.x), glm.vec3(1,0,0))#Recibe radianes            
        # Rotation Y - Yaw
        yaw = glm.rotate(identity, glm.radians(self.camRotation.y), glm.vec3(0,1,0))#Recibe radianes
        # Rotation X - Roll
        roll = glm.rotate(identity, glm.radians(self.camRotation.z), glm.vec3(0,0,1))#Recibe radianes
